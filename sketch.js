...
function setup() {
	...
	ball1 =Bodies.circle(320,380,20,circle_options);
    World.add(world,ball1);

	ball2 = Bodies.circle(360,380,20,circle_options);
    World.add(world,ball2);

	ball3 = Bodies.circle(400,380,20,circle_options);
    World.add(world,ball3);

	ball4 = Bodies.circle(440,380,20,circle_options);
    World.add(world,ball4);

	ball5 = Bodies.circle(480,380,20,circle_options);
